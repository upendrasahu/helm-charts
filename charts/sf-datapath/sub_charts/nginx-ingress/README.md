...
[nginx-ingress](https://github.com/kubernetes/ingress-nginx) Ingress controller for Kubernetes using NGINX as a reverse proxy and load balancer
...
# Helm 2
$ helm install --name [RELEASE_NAME] nginx-ingress/nginx-ingress
```
...
```console
# Helm 2
$ helm inspect values nginx-ingress/nginx-ingress
