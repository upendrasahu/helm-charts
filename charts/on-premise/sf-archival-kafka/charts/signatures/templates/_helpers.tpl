...
Common labels
*/}}
{{- define "signatures.labels" -}}
app.kubernetes.io/name: {{ include "signatures.name" . }}
helm.sh/chart: {{ include "signatures.chart" . }}
...
{{- define "signatures.postgresql.fullname" -}}
...
{{- define "signatures.ingest-controller.fullname" -}}
{{- printf "%s-%s" .Values.global.archival.releaseName "ingest-controller" | trunc 63 | trimSuffix "-" -}}
{{- end -}}

{{- define "signatures.sfk-interface.fullname" -}}
